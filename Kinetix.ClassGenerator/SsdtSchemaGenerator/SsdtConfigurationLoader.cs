...
{
    /// <summary>
    /// Chargeur de la configuration de génération pour SSDT.
    /// </summary>
    public class SsdtConfigurationLoader
    {
        private SsdtParameters _parameters;
        ...
        private static void LoadConfigurationDefaultValue(IDictionary<string, ModelClass> classByTableMap, string configurationFilePath)
        {
            ...
            foreach (XElement tableNode in xDoc.Root.Elements())
            {
                ...
                if (!classByTableMap.TryGetValue(tableName, out ModelClass clazz))
                {
                ...
                foreach (XElement columnNode in tableNode.Elements())
                {
                    ...
                    if (!propertyByColumnMap.TryGetValue(columnName, out ModelProperty property))
                    {
