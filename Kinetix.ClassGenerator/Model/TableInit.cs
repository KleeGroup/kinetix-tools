...
namespace Kinetix.ClassGenerator.Model
{
    ...
    public sealed class TableInit
    {
        ...
        /// </summary>
        public ReadOnlyCollection<ItemInit> ItemInitList => new ReadOnlyCollection<ItemInit>(_dictionary.Values.ToList());
        ...
        public TableInit AddItem(string varName, IDictionary<string, object> bean)
        {
